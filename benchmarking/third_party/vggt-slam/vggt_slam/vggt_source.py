"""
Local VGGT source path utility.

Ensures the correct VGGT source tree (facebookresearch/vggt) is on sys.path
...
def setup_local_vggt_path(vggt_repo=None, default_relative_path=None):
    ...
    vggt_slam_root = this_file.parents[1]  # third_party/vggt-slam
    ...
    for candidate in candidates:
        ...
        if path and path.exists() and (path / "vggt").is_dir():
            ...
            print(f"[VGGT-SLAM] Using local VGGT source: {path_str}")
            return path
