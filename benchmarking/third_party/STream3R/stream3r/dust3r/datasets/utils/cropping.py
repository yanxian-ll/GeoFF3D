...
from stream3r.dust3r.utils.geometry import colmap_to_opencv_intrinsics, opencv_to_colmap_intrinsics  # noqa
try:
...
def crop_image_depthmap(image, depthmap, camera_intrinsics, crop_bbox, track=None, track_valid_mask=None):
    """
