...
VGGT_SLAM_DIR="$ROOT_DIR/benchmarking/third_party/vggt-slam"
VGGT_SLAM2_DIR="$ROOT_DIR/benchmarking/third_party/vggt-slam2.0"
VGGT_LONG_DIR="$ROOT_DIR/benchmarking/third_party/vggt-long"
