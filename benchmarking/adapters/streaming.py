...
Example:
    ...
    python benchmarking/adapters/streaming.py \
      --method lingbot-map \
...
from streaming_methods import create_streaming_method
...
def load_streaming_points(
    ...
    from vggt_optim import load_point_cloud_file, sample_points
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    method = create_streaming_method(args.method, **model_kwargs)
    print(
