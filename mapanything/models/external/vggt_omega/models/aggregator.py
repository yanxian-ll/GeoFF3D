...
from mapanything.models.external.vggt_omega.models.layers import (
    Mlp,
    RopePositionEmbedding,
    SelfAttentionBlock,
)
from mapanything.models.external.vggt_omega.models.layers.vision_transformer import (
...
class Aggregator(nn.Module):
    ...
    def _run_block_with_checkpointing(
        self,
        block: nn.Module,
        tokens: torch.Tensor,
    ...
    def _run_inter_frame_attention_block(
        ...
        camera_and_register_tokens = self._run_block_with_checkpointing(
            self.inter_frame_blocks[block_idx],
