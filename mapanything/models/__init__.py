...
try:
    # Core models that are normally available. Keep this import lazy-tolerant so
    # lightweight external wrappers can still be imported in minimal benchmark
    # environments where optional native deps (e.g. OpenCV/GL) are missing.
...
MODEL_CONFIGS = {
    ...
    "fast3r": {
        "module": "mapanything.models.external.fast3r",
        "class_name": "Fast3RWrapper",
    },
    "mast3r": {
    ...
    "geoff3d": {
        "module": "mapanything.models.external.geoff3d",
        "class_name": "GeoFF3DWrapper",
    },
    "geoff3d_camera_token": {
        "module": "mapanything.models.external.geoff3d",
        "class_name": "GeoFF3DCameraTokenWrapper",
    },
    "pow3r": {
    ...
    "hunyuan_train": {
        "module": "mapanything.models.external.hunyuan_train",
        "class_name": "HunyuanWrapper",
    },
    # Streaming reconstruction methods
    "lingbot-map": {
        "module": "mapanything.models.streaming.lingbot_map",
        "class_name": "LingBotMapWrapper",
    },
    "lingbot_map": {
        "module": "mapanything.models.streaming.lingbot_map",
        "class_name": "LingBotMapWrapper",
    ...
    "streamvggt": {
        "module": "mapanything.models.streaming.streamvggt",
        "class_name": "StreamVGGTWrapper",
    },
    "stream-vggt": {
        "module": "mapanything.models.streaming.streamvggt",
        "class_name": "StreamVGGTWrapper",
    ...
    "stream3r": {
        "module": "mapanything.models.streaming.stream3r",
        "class_name": "STream3RWrapper",
    },
    "ttt3r": {
        "module": "mapanything.models.streaming.ttt3r",
        "class_name": "TTT3RWrapper",
    },
}
...
def model_factory(model_str: str, **kwargs):
    ...
    if "class" in model_config:
        ...
        if model_class is None:
            raise ImportError(
                f"Model '{model_str}' requires core MapAnything modules, but they "
                f"could not be imported: {_CORE_IMPORT_ERROR}"
            )
