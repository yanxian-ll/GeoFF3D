...
The scene input intentionally mirrors scripts/predict_scene_to_rrd_slam_chunks.py:
...
Example:
    ...
    python scripts/run_vggt_slam_to_rrd.py \
      --method vggt-slam \
...
from spatial_rrd.scene_io import voxel_downsample
...
def materialize_images(
    ...
    marker.write_text("generated by scripts/run_vggt_slam_to_rrd.py\n", encoding="utf-8")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    # Match geoff3d-style final point policy.
    ...
    save_final_eval_outputs(
        ...
        meta={
            ...
            "script": "scripts/run_vggt_slam_to_rrd.py",
            "scene_dir": str(Path(args.scene_dir).expanduser().resolve()),
            "method": method,
            "requested_method": requested_method,
            "method_variant": method_variant,
