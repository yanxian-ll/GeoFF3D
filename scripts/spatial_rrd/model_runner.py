...
def resolve_prior_policy(args, model_name: str, meta: Dict[str, object]) -> Dict[str, object]:
    ...
    policy = {
        ...
        # 完整 pose prior：给 mapanything / pi3x / da3 使用
        "pose": "none",
...
WRAPPER_PRETRAINED_PATH_FIELDS = {
    "fast3r": "pretrained_model_name_or_path",
    "pi3": "pretrained_model_name_or_path",
    "pi3x": "pretrained_model_name_or_path",
    "vggt": "pretrained_model_name_or_path",
    "da3": "hf_model_name",
    "da3_nested": "hf_model_name",
    "hunyuan": "hf_model_name",
}

WRAPPER_CHECKPOINT_PATH_FIELDS = {
    "vggt_omega": "checkpoint_path",
}
