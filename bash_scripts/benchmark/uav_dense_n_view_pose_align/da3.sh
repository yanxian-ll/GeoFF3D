...
#
# Benchmark DA3 on UAV dense n-view benchmark (pose align).
#
# Usage:
#   bash bash_scripts/benchmark/uav_dense_n_view/da3_cp.sh [cuda_device]
#
# Override alignment mode:
#   ALIGNMENT_MODE=points bash bash_scripts/benchmark/uav_dense_n_view/da3_cp.sh 0
#   ALIGNMENT_MODE=none   bash bash_scripts/benchmark/uav_dense_n_view/da3_cp.sh 0
