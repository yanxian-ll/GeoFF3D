...
#
# Benchmark Pi3X on UAV dense n-view benchmark (pose align).
#
# Usage:
#   bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp_ft.sh [cuda_device]
#
# Override alignment mode:
#   ALIGNMENT_MODE=points bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp_ft.sh 0
#   ALIGNMENT_MODE=none   bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp_ft.sh 0
...
MODEL_NAME="pi3x"
OUTPUT_NAME="pi3x_p_ft"
ALIGNMENT_MODE="${ALIGNMENT_MODE:-pose}"

# OUTPUT_NAME="pi3x_pose_p_ft"
# ALIGNMENT_MODE="${ALIGNMENT_MODE:-pose}"
