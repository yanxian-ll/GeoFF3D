...
#
# Usage:
#   bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp.sh [cuda_device]
#
# Override alignment mode:
#   ALIGNMENT_MODE=points bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp.sh 0
#   ALIGNMENT_MODE=none   bash bash_scripts/benchmark/uav_dense_n_view/pi3x_cp.sh 0
