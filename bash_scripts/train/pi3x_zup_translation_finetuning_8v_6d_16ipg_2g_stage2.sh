...
torchrun --nproc_per_node ${NUM_GPUS} \
    ...
    loss=pi3x_zup_translation_pose_avgdis_loss_stage2 \
    model=geoff3d \
    ...
    model.pretrained="${STAGE1_CHECKPOINT:-${MAPANYTHING_EXPERIMENTS_ROOT:-./experiments}/dom/uav_training/pi3x_zup_translation_yaw_aug_8v_6d_16ipg_2g/checkpoint-last.pth}" \
    ...
    hydra.run.dir='${root_experiments_dir}/dom/uav_training/pi3x_zup_translation_yaw_aug_8v_6d_16ipg_2g_stage2'
