...
# Stage 2 keeps the no-gravity ablation fixed while matching the standard
# high-resolution Stage-2 training protocol.
torchrun --nproc_per_node ${NUM_GPUS} \
    ...
    loss=pi3x_zup_translation_pose_avgdis_wogravity_loss_stage2 \
    model=geoff3d \
    ...
    model.pretrained='${root_experiments_dir}/dom/uav_training/pi3x_zup_translation_yaw_aug_8v_6d_16ipg_2g_wogravity/checkpoint-last.pth' \
    ...
    train_params=pi3x_zup_translation_stage2_finetune \
    ...
    hydra.run.dir='${root_experiments_dir}/dom/uav_training/pi3x_zup_translation_yaw_aug_8v_6d_16ipg_2g_wogravity_stage2'
