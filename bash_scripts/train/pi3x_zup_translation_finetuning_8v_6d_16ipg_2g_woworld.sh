...
torchrun --nproc_per_node ${NUM_GPUS} \
    ...
    loss=pi3x_zup_translation_geometry_gravity_loss \
    model=geoff3d \
    ...
    hydra.run.dir='${root_experiments_dir}/dom/uav_training/pi3x_zup_translation_yaw_aug_8v_6d_16ipg_2g_woworld'
