...
"""
COLMAP export utilities for GeoFF3D.

This module provides functions to export GeoFF3D predictions to COLMAP format
...
from geoff3d.utils.geometry import closed_form_pose_inverse
...
def build_colmap_reconstruction(
    ...
    """
    Build a pycolmap Reconstruction from GeoFF3D outputs.
...
def export_predictions_to_colmap(
    ...
    """
    High-level function to export GeoFF3D predictions to COLMAP format.
