...
"""
CSS and HTML content for the GeoFF3D Gradio application.
...
def get_header_html(logo_base64=None):
    ...
    <div style="display: flex; align-items: center; margin-bottom: 20px;">
        ...
        <h1 style="margin: 0;"><span style="color: #ffb366;">GeoFF3D:</span> <span style="color: #555555;">Metric 3D Scene Reconstruction</span></h1>
    </div>
    <p>
    <a href="https://github.com/yanxian-ll/GeoFF3D">🌟 GitHub Repository</a>
    </p>
    """
...
def get_description_html():
    ...
    <p>Upload a video or a set of images to create a 3D reconstruction of a scene or object. GeoFF3D takes these images and generates 3D point clouds directly from multi-view images.</p>
    <p>This demo demonstrates the use of image inputs only. However, GeoFF3D is extremely flexible and supports any combination of inputs (images, calibration, poses & depth). For trying out memory efficient inference or additional inputs like cameras & depth, please check out the code in our <a href="https://github.com/yanxian-ll/GeoFF3D">GitHub repository</a>.</p>
    ...
    <p><strong style="color: #555555;">Please note:</strong> <span style="color: #555555;">The inference time changes based on the amount of input images, for e.g., less than 1 second for up to 50 views. However, downloading model weights and visualizing 3D points may take tens of seconds. Please be patient or, for faster visualization, use a local machine to run our demo from our <a href="https://github.com/yanxian-ll/GeoFF3D">GitHub repository</a>. </span></p>
    </div>
    """
