...
"""GeoFF3D inference/training wrapper for the original VGGT-Omega."""
...
from geoff3d.models.external.vggt_omega.models.vggt_omega import VGGTOmega
from geoff3d.models.external.vggt_omega.utils.geometry import (
    closed_form_inverse_se3,
)
from geoff3d.models.external.vggt_omega.utils.pose_enc import (
    encoding_to_camera,
)
from geoff3d.models.external.vggt_omega.utils.rotation import mat_to_quat
...
class VGGTOmegaWrapper(torch.nn.Module):
    """Original VGGT-Omega exposed through the GeoFF3D output contract."""
