...
from geoff3d.models.external.vggt.layers import PatchEmbed
from geoff3d.models.external.vggt.layers.block import Block
from geoff3d.models.external.vggt.layers.rope import (
    PositionGetter,
...
class Aggregator(nn.Module):
    ...
    def __init__(
        ...
        # We set gradient_checkpointing as an instance variable so that it can be accessed in the patch embedding layer when loading pre-trained DINOv2 weights.
    ...
    def _run_block_with_checkpointing(self, block, tokens, pos=None):
        ...
        return checkpoint(custom_forward, tokens, use_reentrant=False)
    ...
    def _process_frame_attention(self, tokens, B, S, P, C, frame_idx, pos=None):
        ...
        for _ in range(self.aa_block_size):
            ...
            tokens = self._run_block_with_checkpointing(
                self.frame_blocks[frame_idx], tokens, pos=pos)
            frame_idx += 1
    ...
    def _process_global_attention(self, tokens, B, S, P, C, global_idx, pos=None):
        ...
        for _ in range(self.aa_block_size):
            ...
            tokens = self._run_block_with_checkpointing(
                self.global_blocks[global_idx], tokens, pos=pos,)
            global_idx += 1
            intermediates.append(tokens.view(B, S, P, C))
