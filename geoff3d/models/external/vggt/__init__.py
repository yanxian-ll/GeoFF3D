...
from geoff3d.models.external.vggt.models.vggt import VGGT
from geoff3d.models.external.vggt.utils.geometry import closed_form_inverse_se3
from geoff3d.models.external.vggt.utils.pose_enc import pose_encoding_to_extri_intri
    ...
    def forward(self, views):
        ...
        with torch.autocast("cuda", enabled=False):
            ...
            depth_map, depth_conf = self.model.depth_head(
                aggregated_tokens_list, images, ps_idx, frames_chunk_size=8
            )

            # Convert the output to GeoFF3D format
            res = []
