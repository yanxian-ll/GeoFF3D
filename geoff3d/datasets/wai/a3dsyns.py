"""
A3D-Syn-S Dataset using WAI format data.
"""
...
class A3DSynSmallWAI(A3DRealWAI):
    """
    A3D-Syn-S dataset containing object-centric and birds-eye-view scenes.
    """
